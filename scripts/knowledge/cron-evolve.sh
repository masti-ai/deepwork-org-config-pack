...
#   0 */6 * * * /home/user/gt/mayor/knowledge/cron-evolve.sh >> /home/user/gt/logs/knowledge-evolve.log 2>&1

set -euo pipefail

LOCKFILE="/tmp/knowledge-evolve.lock"
LOGFILE="/home/user/gt/logs/knowledge-evolve.log"
KB_DIR="/home/user/gt/mayor/knowledge"
...
CL_SCRIPT="/home/user/gt/mayor/changelog/append.sh"

for rig in project_gamma project_delta project_beta project_alpha; do
